# Since we are currently using a work-around to load JSON instead of CSV, this
...
test_that("get_lithuania_regional_cases returns the correct column names", {
  ...
  expected_colnames_adm_level_1 <- c( "date", "region_level_1", "cases_new")
  ...
  expected_colnames_adm_level_2 <- c("date", "region_level_1", "region_level_2", "cases_new")
